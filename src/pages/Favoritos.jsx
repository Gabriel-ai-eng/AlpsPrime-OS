              ...
              {favorites.map((app, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 relative z-10 min-w-0">
                    <div className="w-12 h-12 rounded-[20px] bg-muted border border-border flex items-center justify-center flex-shrink-0 overflow-hidden group-hover:scale-105 transition-transform duration-500 group-hover:border-gold/30 group-hover:shadow-[0_0_20px_rgba(201,162,79,0.15)]">
                      <img src={app.logoQuadrado || app.logo} alt={app.nome} className="w-full h-full object-cover" decoding="async" />
                    </div>
