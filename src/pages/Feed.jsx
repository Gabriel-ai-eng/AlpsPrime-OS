    ...
    <div className="w-full h-[100dvh] bg-black text-white overflow-hidden">
      {telaAtual === 'hub' && (
        <div className="w-full h-full overflow-y-auto scrollbar-none">
          ...
          <div className="sticky top-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/5">
            <div className="flex items-center justify-between px-6 pt-5 pb-4">
              ...
              <div className="flex items-center gap-4">
                <button className="text-white/70 active:scale-95 transition-transform">
          ...
          {/* SLIDER NORMAL (fica no topo ao subir, mas não acompanha o scroll) */}
          <div
          ...
          >
                  ...
                  {slide.titulo && (
                    <div className="text-center px-6">
                      <h1
                        ...
                        style={{
                          textShadow:
                            '0 0 4px rgba(255,255,255,0.9), 0 0 12px rgba(255,255,255,0.6), 0 0 24px rgba(255,255,255,0.4)'
                        }}
                      >
                        Alps OS
                      </h1>
            ...
            <button
              onClick={() => navSlide(-1)}
              className="absolute left-3 top-1/2 -translate-y-1/2 p-2 text-white/40 hover:text-white transition-colors active:scale-90"
            >
            ...
            <button
              onClick={() => navSlide(1)}
              className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-white/40 hover:text-white transition-colors active:scale-90"
            >
