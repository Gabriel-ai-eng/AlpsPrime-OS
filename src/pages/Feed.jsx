...
export default function Feed() {
  ...
  return (
    <div className="w-full h-full bg-black text-white font-sans relative overflow-hidden flex flex-col selection:bg-white/30">

      {telaAtual === 'hub' && (
        <div className="flex-1 w-full overflow-y-auto overflow-x-hidden scrollbar-none flex flex-col items-center pt-8 px-6 pb-32 z-10 relative animate-fade-in">
                    ...
                    {slide.type === 'titulo' ? (
                      <div className="text-center">
                        <h1
                          ...
                          style={{
                            textShadow: '0 0 4px rgba(255,255,255,0.9), 0 0 12px rgba(255,255,255,0.6), 0 0 24px rgba(255,255,255,0.4), 0 0 45px rgba(255,255,255,0.2)'
                          }}
                        >
                          Alps OS
                        </h1>
                      ...
                      <div className={`w-full h-24 rounded-[20px] ${slide.cor} shadow-[0_0_30px_rgba(255,255,255,0.05)] overflow-hidden relative`}>
                        {/* Insira as imagens de slide aqui depois */}
                      </div>
                    )}
                  </div>
                ))}
