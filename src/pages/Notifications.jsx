  ...
  return (
    <div className="w-full h-[100dvh] bg-background text-foreground font-sans overflow-y-auto overflow-x-hidden scrollbar-none flex flex-col relative select-none">
      ...
      {/* =========================================
          CABEÇALHO FIXO
          ========================================= */}
      <header className="w-full bg-white backdrop-blur-3xl pt-4 pb-4 px-5 flex items-center justify-between z-20 sticky top-0 border-b border-border shadow-sm">
