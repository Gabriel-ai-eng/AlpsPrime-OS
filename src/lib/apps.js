...
export const APPS = [
  { id: 'armor', nome: 'Projeto Armor', desc: 'Jogo de ação e sobrevivência.', cat: 'jogos', logo: '/apps/armor-logo.webp', logoQuadrado: '/apps/armor-logo-square.webp', status: 'live', url: '/jogo' },
