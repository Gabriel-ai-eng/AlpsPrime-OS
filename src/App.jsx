...
import {
  ...
  Settings, HelpCircle, Grid, LayoutList, Star, Sparkles, X
} from 'lucide-react';
  ...
  return (
    <div className="flex h-screen w-full max-w-[100vw] overflow-hidden relative bg-black text-white selection:bg-white/30">
      ...
      {/* =========================================
          ...
          Movido para o final para garantir sobreposição total do BottomNav
          ========================================= */}
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-[9999999] flex items-center justify-center p-5 bg-black/50 backdrop-blur-xl animate-in fade-in duration-300">
          ...
          >
            ...
            {/* BOTÃO FECHAR 'X' RECUPERADO AQUI */}
            <div className="flex justify-end p-2 pb-0 relative z-20">
              <button 
            ...
            <div className="relative px-5 pb-8 pt-2 space-y-7">
