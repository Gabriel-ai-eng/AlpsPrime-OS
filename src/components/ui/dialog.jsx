  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      style={{
        ...
        boxShadow: '0 24px 80px rgba(120,90,40,0.12), 0 4px 16px rgba(0,0,0,0.06), 0 1px 0 rgba(255,255,255,1) inset',
      }}
      {...props}>
      {/* Shine stripe */}
      <div style={{ position:'absolute', top:0, left:0, right:0, height:1, background:'linear-gradient(90deg, transparent, rgba(255,255,255,0.10), transparent)', borderRadius:'inherit', pointerEvents:'none' }} />
      {children}
